              ...
              <div className="relative flex justify-center items-center w-full h-full">
                ...
                >
                  <img
                    ...
                    alt=""
                  />
                  <a href="https://wallet-clone-gamma.vercel.app/" className="absolute inset-0 m-auto cursor-pointer">
                  <video
                    autoPlay
                    loop
                    muted
                  ...
                  <div className="flex flex-row pt-4">
                    <a href="https://wallet-clone-gamma.vercel.app/" className="cursor-pointer">
                    <h3 className="flex font-semibold text-3xl md:text-[50px] pb-10 md:pb-20">
                      Crypto Wallet
                    </h3>
                    </a>
                    <a href="https://github.com/AryanSeth009/wallet_clone" className="pt-2 md:pt-2 ml-auto cursor-pointer">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="36"
...
{/*3rd project */}
          <div className="flex flex-col md:flex-row mb-4 pb-16 md:pb-32">
            ...
            <div className="flex w-full md:w-auto h-[400px] md:h-[580px] relative px-4 md:mr-20">
              <div className="relative flex justify-center items-center w-full h-full">
                <a
                  href="https://talent-ranker.vercel.app/"
                  className="relative w-full"
                >
                  <img
                    className="w-full md:w-[700px] h-[300px] md:h-[600px]  rounded-lg object-cover"
                    src="https://www.sourcely.net/blog-images/top-20-literature-review-examples/what-is-a-literature-review.jpg"
                    alt=""
                  />
                  <a href="https://talent-ranker.vercel.app/" className="absolute inset-0 m-auto cursor-pointer">
                  <video
                    autoPlay
                    loop
                    muted
                  ...
                  <div className="flex flex-row pt-4">
                    <a href="https://talent-ranker.vercel.app/" className="cursor-pointer">
                    <h3 className="flex font-semibold text-3xl md:text-[50px] pb-10 md:pb-20">
                      TalentRanker.Ai
                    </h3>
                    </a>
                    <a href="https://github.com/AryanSeth009/TalentRanker" className="pt-2 md:pt-2 ml-auto cursor-pointer">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="36"
          ...
          */}
            ...
            <div className="flex flex-col md:flex-row mb-4 pb-16 md:pb-32">
              ...
              <div className="flex w-full md:w-auto h-[400px] md:h-[580px] relative px-4 md:mr-20">
                <div className="relative flex justify-center items-center w-full h-full">
                  <a
                    href="https://unibookmark.vercel.app/"
                    className="relative w-full"
                  >
                    <img
                      className="w-full md:w-[700px] h-[300px] md:h-[600px]  rounded-lg object-cover"
                      src="https://i.etsystatic.com/22970031/r/il/3519eb/5592876185/il_fullxfull.5592876185_1kk1.jpg"
                      alt=""
                    />
                    <a href="https://unibookmark.vercel.app/" className="absolute inset-0 m-auto cursor-pointer">
                    <video
                      autoPlay
                      loop
                      muted
                      className="v_1 absolute h-[300px] md:h-[600px] w-[90%] md:w-[650px] inset-0 m-auto"
                      src="./videos/unibookmark.mp4"
                    ></video>
                    </a>
                    <div className="flex flex-row pt-4">
                      <a href="https://unibookmark.vercel.app/" className="cursor-pointer">
                      <h3 className="flex font-semibold text-3xl md:text-[50px] pb-10 md:pb-20">
                        Unibookmark
                      </h3>
                      </a>
                      <a href="https://github.com/AryanSeth009/UniBookmark" className="pt-2 md:pt-2 ml-auto cursor-pointer">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          width="36"
            ...
            <div className="flex flex-col md:flex-row mb-4 pb-16 md:pb-32">
              ...
              <div className="flex !cursor-pointer w-full md:w-auto h-[400px] md:h-[580px] relative px-4 md:mr-20">
                <div className="relative flex justify-center items-center w-full h-full">
                  <a
                    href="https://v0-ai-chat-app-snowy.vercel.app/"
                    className="relative w-full"
                  >
                    <img
                      className="w-full md:w-[700px] h-[300px] md:h-[600px]  rounded-lg object-cover"
                      src="https://static.vecteezy.com/system/resources/previews/020/539/517/non_2x/modern-chat-ai-technology-background-free-vector.jpg"
                      alt=""
                    />
                    <a href="https://v0-ai-chat-app-snowy.vercel.app/" className="absolute inset-0 m-auto cursor-pointer">
                    <video
                      autoPlay
                      loop
                      muted
                      className="v_1 absolute h-[300px] md:h-[600px] w-[90%] md:w-[650px] inset-0 m-auto"
                      src="./videos/FynqAi.mp4"
                    ></video>
                    </a>
                    <div className="flex flex-row pt-4">
                      <a href="https://v0-ai-chat-app-snowy.vercel.app/" className="cursor-pointer">
                      <h3 className="flex font-semibold text-3xl md:text-[50px] pb-10 md:pb-20">
                       FynqAi
                      </h3>
                      </a>
                      <a href="https://github.com/AryanSeth009/ai-chat-app" className="pt-2 md:pt-2 ml-auto cursor-pointer ">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          width="36"
